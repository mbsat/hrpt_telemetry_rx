...
# Author: Martin Blaho
# Generated: Sun Jun 19 10:18:07 2011
##################################################
...
class usrp2_rx_metop_ahrpt_bb_fr(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	parser.add_option("", "--frames-file", dest="frames_file", type="string", default=os.environ['HOME'] + '/metop_ahrpt_frames.cadu',
		help="Set CADU frames output filename [default=%default]")
	parser.add_option("", "--baseband-file", dest="baseband_file", type="string", default=os.environ['HOME'] + '/metop_ahrpt_baseband.dat',
	...
	tb = usrp2_rx_metop_ahrpt_bb_fr(gain=options.gain, clock_alpha=options.clock_alpha, freq=options.freq, decim=options.decim, satellite=options.satellite, symb_rate=options.symb_rate, pll_alpha=options.pll_alpha, deframer_insync_frames=options.deframer_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames, frames_file=options.frames_file, baseband_file=options.baseband_file, viterbi_sync_threshold=options.viterbi_sync_threshold, viterbi_insync_frames=options.viterbi_insync_frames, viterbi_outsync_frames=options.viterbi_outsync_frames)
	tb.Run(True)
