...
# Author: Martin Blaho
# Generated: Fri Jul 15 20:24:02 2011
##################################################
...
class usrp2_rx_noaa_hrpt_fr(grc_wxgui.top_block_gui):

	def __init__(self, pll_alpha=0.005, satellite='NOAA18', decim=50, gain=25, clock_alpha=0.005, freq=1707e6, symb_rate=600*1109, baseband_file=os.environ['HOME'] + '/noaa_hrpt_baseband.dat', frames_file=os.environ['HOME'] + '/noaa_hrpt_frames.hmf', deframer_sync_check=False, deframer_insync_frames=2, deframer_outsync_frames=5):
...
if __name__ == '__main__':
	...
	parser.add_option("", "--satellite", dest="satellite", type="string", default='NOAA18',
	...
	parser.add_option("", "--freq", dest="freq", type="eng_float", default=eng_notation.num_to_str(1707e6),
	...
	parser.add_option("", "--deframer-sync-check", dest="deframer_sync_check", type="intx", default=False,
		help="Set Deframer synchronisation check [default=%default]")
	...
	tb = usrp2_rx_noaa_hrpt_fr(pll_alpha=options.pll_alpha, satellite=options.satellite, decim=options.decim, gain=options.gain, clock_alpha=options.clock_alpha, freq=options.freq, symb_rate=options.symb_rate, baseband_file=options.baseband_file, frames_file=options.frames_file, deframer_sync_check=options.deframer_sync_check, deframer_insync_frames=options.deframer_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames)
	tb.Run(True)
