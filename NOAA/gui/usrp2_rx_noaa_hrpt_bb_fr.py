...
# Author: Martin Blaho
# Generated: Wed Jul 13 09:55:24 2011
##################################################
...
class usrp2_rx_noaa_hrpt_bb_fr(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = usrp2_rx_noaa_hrpt_bb_fr(pll_alpha=options.pll_alpha, satellite=options.satellite, decim=options.decim, gain=options.gain, clock_alpha=options.clock_alpha, freq=options.freq, deframer_insync_frames=options.deframer_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames, symb_rate=options.symb_rate, baseband_file=options.baseband_file, frames_file=options.frames_file)
	tb.Run(True)
