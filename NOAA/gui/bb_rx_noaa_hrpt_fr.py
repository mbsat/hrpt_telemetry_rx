...
# Generated: Thu Jan 27 13:42:11 2011
##################################################
...
class bb_rx_noaa_hrpt_fr(grc_wxgui.top_block_gui):
...
if __name__ == '__main__':
	...
	tb = bb_rx_noaa_hrpt_fr(deframer_insync_frames=options.deframer_insync_frames, deframer_outsync_frames=options.deframer_outsync_frames, pll_alpha=options.pll_alpha, satellite=options.satellite, decim=options.decim, symb_rate=options.symb_rate, baseband_file=options.baseband_file, frames_file=options.frames_file, clock_alpha=options.clock_alpha)
	tb.Run(True)
